# Antikode Security Framework

Antikode is ISO 27001 certified. All projects are built and operated under our Information Security Management System (ISMS). The following controls are standard across all web projects.
...
- Automatic OS patching schedule on all EC2 instances
